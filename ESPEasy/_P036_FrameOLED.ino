    ...
    case PLUGIN_WEBFORM_SAVE:
      {
        ...
        for (byte varNr = 0; varNr < Nlines; varNr++)
        {
          ...
          //String log = "";
          //log = String(F("     OLED SSD1306 - save line")) + String(varNr) + String(F(" Value: ")) + String(deviceTemplate[varNr]);
    ...
    case PLUGIN_INIT:
      {
        ...
        //{
        //   String log = "";
        //   log = String(F("     OLED SSD1306 - INIT")) + String(varNr) + String(F(" Value: ")) + String(deviceTemplate[varNr]);
        //   addLog(LOG_LEVEL_INFO, log);
        //}
    ...
    case PLUGIN_READ:
      {
        ...
        //{
        //   String log = "";
        //   log = String(F("     OLED SSD1306 - READ")) + String(varNr) + String(F(" Value: ")) + String(deviceTemplate[varNr]);
        //   addLog(LOG_LEVEL_INFO, log);
        //}
